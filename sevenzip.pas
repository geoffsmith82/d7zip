...
const
  ...
  CLSID_CFormatAvb      : TGUID = '{23170F69-40C1-278A-1000-000110C00000}'; // avb
  CLSID_CFormatLp       : TGUID = '{23170F69-40C1-278A-1000-000110C10000}'; // lp
  CLSID_CFormatSparse   : TGUID = '{23170F69-40C1-278A-1000-000110C20000}'; // sparse
  CLSID_CFormatApfs     : TGUID = '{23170F69-40C1-278A-1000-000110C30000}'; // apfs
